import delimited "C:\Users\Sherry\Downloads\EXGR\EXGR.csv"
rename v1 EXGR
rename v2 Exp_cou 
rename v3 Imp_cou
rename v4 Exp_ind
rename v5 Year
rename v6 export
save "D:\RCEP Research\data\gravity_raw_data\TIVA\latest_year\EXGR.dta",replace  //
import delimited "C:\Users\Sherry\Downloads\EXGR_FNL\EXGR_FNL.csv"
rename v1 EXGR_FNL
rename v2 Exp_cou 
rename v3 Imp_cou
rename v4 Exp_ind
rename v5 Year
rename v6 export_fnl
save "D:\RCEP Research\data\gravity_raw_data\TIVA\latest_year\EXGR_FNL.dta",replace
import delimited "C:\Users\Sherry\Downloads\EXGR_INT\EXGR_INT.csv"
rename v1 EXGR_INT
rename v2 Exp_cou 
rename v3 Imp_cou
rename v4 Exp_ind
rename v5 Year
rename v6 export_int
save "D:\RCEP Research\data\gravity_raw_data\TIVA\latest_year\EXGR_INT.dta",replace
import delimited "C:\Users\Sherry\Downloads\PROD (1)\PROD.csv"
rename v1 PROD
rename v2 Prod_cou
rename v3 World
rename v4 Prod_ind
rename v5 Year
rename v6 production
order Year,first
drop PROD
sort Year Prod_cou Prod_ind
save "D:\RCEP Research\data\gravity_raw_data\TIVA\latest_year\PROD.dta",replace  //
import delimited "C:\Users\Sherry\Downloads\PROD_VASH(1)\PROD_VASH.csv", encoding(ISO-8859-2) 
rename v1 PROD_VASH
rename v2 Prod_cou
rename v3 World
rename v4 Prod_ind
rename v5 Year
rename v6 prod_percent
order Year,first
sort Year Prod_cou Prod_ind
save "D:\RCEP Research\data\gravity_raw_data\TIVA\latest_year\PROD_VASH.dta",replace //
import delimited "C:\Users\Sherry\Downloads\EXGRPSH\EXGRpSH.csv"
rename v1 EXGRpSH
rename v2 Exp_cou 
rename v3 Imp_cou
rename v4 Exp_ind
rename v5 Year
rename v6 export_per
save "D:\RCEP Research\data\gravity_raw_data\TIVA\latest_year\EXGRpSH.dta",replace       //
